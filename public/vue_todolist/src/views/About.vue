<template>
  <div class="container about text-left">
    <section id="about" class="about">
      <div class="container">
        <div class="section-title text-left">
          <h2 class="text-center">Reihan Andhika Putra</h2>
          <h3>About</h3>
        ...
        <div class="row">
          <div class="col-lg-4" >
            <img src="assets/images/Foto_13519043_Reihan Andhika P.jpg" class="" alt="">
          </div>
          <div class="col-lg-8 pt-0 mt-0 content" >
            <h3>Web Developer</h3>
            <p class="font-italic">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong> 2 May 2001</li>
